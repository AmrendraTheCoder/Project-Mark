import { History, Plus, Users2, Bell, Settings, ChevronDown, LayoutGrid } from 'lucide-react'
    ...
    <div className='bg-gray-100 h-[6.6vh] flex items-center justify-between px-3 border-b border-slate-200 shadow'>
        ...
        <div className='flex justify-center items-center gap-3'>
            ...
            <div className='flex gap-4'>
              ...
              {/* Image Tag */}
              <button>
                <Image src="/user.jpg" alt="user image" width={96} height={96} className=' w-8 h-8 rounded-full border-slate-600 border'/>
              </button>
              {/* Layout grid */}
              <button>
